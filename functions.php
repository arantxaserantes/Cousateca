...
function cousateca_scripts() {
	...
	wp_enqueue_script("bm-popper-js", "https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js", array('jquery'), '1.0', true);
	wp_enqueue_script("bm-bootstrap-js", "https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js", array('bm-popper-js', 'jquery'), '1.0', true);
	wp_enqueue_script("bm-custom-js", $template_url."/js/custom.js", array('bm-bootstrap-js', 'bm-popper-js', 'jquery'), '1.0', true);
...
function wpse_lost_password_redirect_1() {

    // Check if have submitted
    $confirm = ( isset($_GET['checkemail'] ) ? $_GET['checkemail'] : '' );

    if( $confirm ) {
        wp_redirect( home_url() . '/engadir-unha-cousa' );
        exit;
    }
}
add_action('login_headerurl', 'wpse_lost_password_redirect_1');
