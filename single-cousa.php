			...
			<article class="post-entry">
				...
				<div class="termos">
					<div class="term">
						...
						?>
						<button type="button">(Ver licenza).</button>
				   </div>

				   <div id="contenedor_licenza_form">
					   <button type="button" class="cerrar"><i class="material-icons">close</i></button>
					   <h3>Licenza</h3>
					   <div class="dentro_licenza">
						   <?php echo get_post_meta(get_the_ID(), 'bm_cousaform_licenza_escollida', true); ?>
						   <p class="info_xeral">@ prestatari@ pode cancelar calquera condición cando queira comunicándollo @ usuari@. En principio, a non ser que @ prestatari@ diga o contrario, deixa a cousa tal e como a atopaches.</p>
					   </div>
				   </div>
				...
				<div class="ficha">
					<div class="row">
						...
						<div class="col-12 col-sm-12 col-md-3">
							...
							<?php if(get_post_meta(get_the_ID(), 'bm_cousaform_ata', true)){ ?>
							<div class="datas">
								Dispoñible ata o
